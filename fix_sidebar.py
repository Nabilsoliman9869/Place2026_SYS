...
# Fix sidebar logic to remove redundant "Main" link
    ...
    <div class="d-flex">
      <div class="sidebar p-3" style="width: 250px;">
        ...
        <ul class="nav flex-column">
          ...
          <!-- Main Dashboard Link (Only for Manager or if no specific role dashboard exists) -->
          {% if g.user and g.user['Role'] == 'Manager' %}
          <li class="nav-item">
            <a href="{{ url_for('dashboard') }}"><i class="fas fa-home"></i> الرئيسية (إدارة)</a>
          </li>
          {% endif %}
          ...
          <li class="nav-item">
            <a href="{{ url_for('corporate_manage') }}"><i class="fas fa-building"></i> إدارة الشركات والطلبات</a>
          </li>
          {% endif %}
          ...
          <li class="nav-item">
            <a href="{{ url_for('sales_index') }}"><i class="fas fa-bullhorn"></i> المبيعات والحملات</a>
          </li>
          {% endif %}
          ...
          <li class="nav-item">
            <a href="{{ url_for('training_index') }}"><i class="fas fa-chalkboard-teacher"></i> التدريب والاختبارات</a>
          </li>
          {% endif %}
